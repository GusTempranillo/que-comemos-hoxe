...
Estado: **En desenvolvemento**. Os workflows de n8n (primeiros CRUD, login, compartición) xa están preparados e conectados con Supabase (infraestrutura, fóra deste repo — ver `TASK_PLAN.md` 2.8). Falta conectar o frontend de verdade: login (2.2), consumo real de `js/api.js` (2.4) e sincronización offline-first (2.5).
...
> Nota 2026-08-05: Supabase xa está conectada dende n8n (ver Fase 2 / `TASK_PLAN.md` 2.8). Queda por confirmar contra `DATABASE_MODEL.md` se o esquema, historial e versionado desta fase están xa implementados ou só a conexión básica.
